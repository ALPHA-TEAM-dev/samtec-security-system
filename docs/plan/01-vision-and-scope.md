...
- **Biometric attendance:** a fingerprint terminal first, a face-recognition kiosk second, with offline sync.
...
- A mobile app. The kiosk is a web page, so guards need no app in version 1.
